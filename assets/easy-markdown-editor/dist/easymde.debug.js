...
},{"typo-js":16}],3:[function(require,module,exports){
...
},{"../../addon/mode/overlay":7,"../../lib/codemirror":10,"../markdown/markdown":12}],12:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/5/LICENSE
...
function _toggleHeading(cm, direction, size) {
    ...
    var sharpLevels = cm.mode.headingLevels || (cm.options.backdrop ? (cm.options.backdrop.headingLevels || []) : []),
...
EasyMDE.prototype.render = function (el) {
    ...
    if (options.parsingConfig.headingLevels) {
        ...
        var headingCheckNew = function(cm, obj) {
            ...
            var myLevels = headingNeedUpdate(currHeading, cm.mode.headingLevels || cm.options.backdrop.headingLevels);
        ...
        var headingCheckExisting = function(cm, obj) {
            ...
            if ((obj.from.line === obj.to.line) && obj.text.length < 2) {
                ...
                if (/input/.test(obj.origin) && obj.text[0] === '#') {
                    ...
                    myLevels = headingNeedUpdate(myText, cm.mode.headingLevels || cm.options.backdrop.headingLevels);
                    if (!myLevels) {
                        return false;
                    }
                    if (myLevels.to < myLevels.from) {
